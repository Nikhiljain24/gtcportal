...
<?php
$getprob = $qgen->select('tbl_problem','*','prob_id="143"');
...
$body = "--1a2a3a\r\n" .
 ...
 <body></pre>
<span style='color: red;'><strong>Please Respond to the following mail Immediately<br>This Mail Contain Attached Image :</strong></span>
